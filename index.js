...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        <p> Raised: $${game.pledged.toLocaleString("en-US")} / ${game.goal.toLocaleString("en-US")} </p>
        `;
...
function filterUnfundedOnly() {
    ...
    console.log("unfunded games: " + unfundedGames.reduce((sum, game) => sum + 1, 0));
}
...
function filterFundedOnly() {
    ...
    console.log("funded games: " + fundedGames.reduce((sum, game) => sum + 1, 0));
}
...
let descriptionStr = `There ${unfundedGamesCount > 1 ? "are" : "is"} ${unfundedGamesCount} unfunded game${unfundedGamesCount > 1 ? "s" : ""}.`

// create a new DOM element containing the template string and append it to the description container
let paragraph = document.createElement("p");
paragraph.innerText = descriptionStr;
