...
While building the app, I ran into some challenges.
Firstly, It was difficult to create the description that mentions the unfunded games,
since it uses a ternary operator to display correct grammar. 
It was also a challenge to succinctly display the top 2 games,
which I managed to do by destructing with the spread operator.
